import { z } from "zod";
import { ASSET_STATUSES, ASSET_TEMPLATES } from "@/lib/db/schema/assets";
...
export const createAssetSchema = z.object({
  ...
  templateKey: z.enum(ASSET_TEMPLATES).default("minimal-modern"),
...
export const uploadAssetFilesSchema = z.object({
