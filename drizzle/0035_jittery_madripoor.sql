CREATE TABLE "mitfloww"."invoice_settings" (
	...
	"notes" text,
	"terms" text,
	"paper_size" varchar(16) DEFAULT 'a4' NOT NULL,
	"font_family" varchar(64),
	"font_weight" varchar(32),
	"font_style" varchar(32),
	"custom_template_name" varchar(100),
	"custom_elements" text[],
	"custom_layout_direction" varchar(16),
	"custom_element_offsets" text,
	"custom_element_styles" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "invoice_settings_user_id_unique" UNIQUE("user_id")
);
--> statement-breakpoint
ALTER TABLE "mitfloww"."invoice_settings" ADD CONSTRAINT "invoice_settings_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "mitfloww"."users"("id") ON DELETE cascade ON UPDATE no action;